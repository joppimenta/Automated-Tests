...
def when(context):
    edition_field = context.driver.find_element_by_id("edition")
    edition_field.send_keys("A Diego Edition")
...
def then(context):
    WebDriverWait(context.driver, 60).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//*[@id='body']/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td[4]"), "A Diego Edition"))