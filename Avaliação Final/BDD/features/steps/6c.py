...
def when(context):
    country_field = context.driver.find_element_by_id("country")
    country_field.send_keys("A Diego Country")
...
def then(context):
    ...
    WebDriverWait(context.driver, 60).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//*[@id='collapse0']/td[2]"), "A Diego Country"))
