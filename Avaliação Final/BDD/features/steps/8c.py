...
def when(context):
    city_field = context.driver.find_element_by_id("city")
    city_field.send_keys("A Diego City")
...
def then(context):
    ...
    WebDriverWait(context.driver, 60).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//*[@id='collapse0']/td[4]"), "A Diego City"))
