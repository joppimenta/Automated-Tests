...
def when(context):
    ...
    name_field.send_keys("Acme Miniempresa")
...
def then(context):
    WebDriverWait(context.driver, 60).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//*[@id='body']/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td[2]"), "Acme Miniempresa"))