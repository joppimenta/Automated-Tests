...
def when(context):
    key_field = context.driver.find_element_by_id("key")
    key_field.send_keys("A25J9M6DG5")
...
def then(context):
    WebDriverWait(context.driver, 60).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//*[@id='body']/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td[3]"), "A25J9M6DG5"))